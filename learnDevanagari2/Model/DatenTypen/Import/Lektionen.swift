...
func erstelleLektionen() -> [Lektion]
{
    ...
    //nummer
    for lektion in lektionen.enumerated()   { lektion.element.nummer = lektion.offset + 1 }
    ...
    lektionen[2-1].quizSetting?.vokalOderKonsonant    = .init(controlTyp: .VokalOderKonsonantTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[3-1].quizSetting?.vokalOderKonsonant    = .init(controlTyp: .VokalOderKonsonantTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[4-1].quizSetting?.vokalOderKonsonant    = .init(controlTyp: .VokalOderKonsonantTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[5-1].quizSetting?.vokalOderKonsonant    = .init(controlTyp: .VokalOderKonsonantTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[6-1].quizSetting?.vokalOderKonsonant    = .init(controlTyp: .VokalOderKonsonantTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[7-1].quizSetting?.vokalOderKonsonant    = .init(controlTyp: .VokalOderKonsonantTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[8-1].quizSetting?.vokalOderKonsonant    = .init(controlTyp: .VokalOderKonsonantTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[9-1].quizSetting?.vokalOderKonsonant    = .init(controlTyp: .VokalOderKonsonantTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[10-1].quizSetting?.vokalOderKonsonant    = .init(controlTyp: .VokalOderKonsonantTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[11-1].quizSetting?.vokalOderKonsonant    = .init(controlTyp: .VokalOderKonsonantTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[12-1].quizSetting?.vokalOderKonsonant    = .init(controlTyp: .VokalOderKonsonantTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[13-1].quizSetting?.vokalOderKonsonant    = .init(controlTyp: .VokalOderKonsonantTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[14-1].quizSetting?.vokalOderKonsonant    = .init(controlTyp: .VokalOderKonsonantTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[15-1].quizSetting?.vokalOderKonsonant    = .init(controlTyp: .VokalOderKonsonantTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[16-1].quizSetting?.vokalOderKonsonant    = .init(controlTyp: .VokalOderKonsonantTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[17-1].quizSetting?.vokalOderKonsonant    = .init(controlTyp: .VokalOderKonsonantTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[18-1].quizSetting?.vokalOderKonsonant    = .init(controlTyp: .VokalOderKonsonantTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[19-1].quizSetting?.vokalOderKonsonant    = .init(controlTyp: .VokalOderKonsonantTyp, modus: .Abfrage, konsonantTypModus: nil)
    ...
    lektionen[3-1].quizSetting?.textfeld                  = .init(controlTyp: .TextfeldTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[4-1].quizSetting?.textfeld                  = .init(controlTyp: .TextfeldTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[5-1].quizSetting?.textfeld                  = .init(controlTyp: .TextfeldTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[6-1].quizSetting?.textfeld                  = .init(controlTyp: .TextfeldTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[7-1].quizSetting?.textfeld                  = .init(controlTyp: .TextfeldTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[8-1].quizSetting?.textfeld                  = .init(controlTyp: .TextfeldTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[9-1].quizSetting?.textfeld                  = .init(controlTyp: .TextfeldTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[10-1].quizSetting?.textfeld                  = .init(controlTyp: .TextfeldTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[11-1].quizSetting?.textfeld                  = .init(controlTyp: .TextfeldTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[12-1].quizSetting?.textfeld                  = .init(controlTyp: .TextfeldTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[13-1].quizSetting?.textfeld                  = .init(controlTyp: .TextfeldTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[14-1].quizSetting?.textfeld                  = .init(controlTyp: .TextfeldTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[15-1].quizSetting?.textfeld                  = .init(controlTyp: .TextfeldTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[16-1].quizSetting?.textfeld                  = .init(controlTyp: .TextfeldTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[17-1].quizSetting?.textfeld                  = .init(controlTyp: .TextfeldTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[18-1].quizSetting?.textfeld                  = .init(controlTyp: .TextfeldTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[19-1].quizSetting?.textfeld                  = .init(controlTyp: .TextfeldTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[20-1].quizSetting?.textfeld                  = .init(controlTyp: .TextfeldTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[21-1].quizSetting?.textfeld                  = .init(controlTyp: .TextfeldTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[22-1].quizSetting?.textfeld                  = .init(controlTyp: .TextfeldTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[23-1].quizSetting?.textfeld                  = .init(controlTyp: .TextfeldTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[24-1].quizSetting?.textfeld                  = .init(controlTyp: .TextfeldTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[25-1].quizSetting?.textfeld                  = .init(controlTyp: .TextfeldTyp, modus: .Abfrage, konsonantTypModus: nil)
    ...
    lektionen[5-1].quizSetting?.artikulation              = .init(controlTyp: .ArtikulationTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[6-1].quizSetting?.artikulation              = .init(controlTyp: .ArtikulationTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[7-1].quizSetting?.artikulation              = .init(controlTyp: .ArtikulationTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[8-1].quizSetting?.artikulation              = .init(controlTyp: .ArtikulationTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[9-1].quizSetting?.artikulation              = .init(controlTyp: .ArtikulationTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[10-1].quizSetting?.artikulation             = .init(controlTyp: .ArtikulationTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[11-1].quizSetting?.artikulation             = .init(controlTyp: .ArtikulationTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[12-1].quizSetting?.artikulation             = .init(controlTyp: .ArtikulationTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[13-1].quizSetting?.artikulation             = .init(controlTyp: .ArtikulationTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[14-1].quizSetting?.artikulation             = .init(controlTyp: .ArtikulationTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[15-1].quizSetting?.artikulation             = .init(controlTyp: .ArtikulationTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[16-1].quizSetting?.artikulation             = .init(controlTyp: .ArtikulationTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[17-1].quizSetting?.artikulation             = .init(controlTyp: .ArtikulationTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[18-1].quizSetting?.artikulation             = .init(controlTyp: .ArtikulationTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[19-1].quizSetting?.artikulation             = .init(controlTyp: .ArtikulationTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[20-1].quizSetting?.artikulation             = .init(controlTyp: .ArtikulationTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[21-1].quizSetting?.artikulation             = .init(controlTyp: .ArtikulationTyp, modus: .Abfrage, konsonantTypModus: nil)
    ...
    lektionen[10-1].quizSetting?.aspiration       = .init(controlTyp: .AspirationTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[11-1].quizSetting?.aspiration       = .init(controlTyp: .AspirationTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[12-1].quizSetting?.aspiration       = .init(controlTyp: .AspirationTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[13-1].quizSetting?.aspiration       = .init(controlTyp: .AspirationTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[14-1].quizSetting?.aspiration       = .init(controlTyp: .AspirationTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[15-1].quizSetting?.aspiration       = .init(controlTyp: .AspirationTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[16-1].quizSetting?.aspiration       = .init(controlTyp: .AspirationTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[17-1].quizSetting?.aspiration       = .init(controlTyp: .AspirationTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[18-1].quizSetting?.aspiration       = .init(controlTyp: .AspirationTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[19-1].quizSetting?.aspiration       = .init(controlTyp: .AspirationTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[20-1].quizSetting?.aspiration       = .init(controlTyp: .AspirationTyp, modus: .Abfrage, konsonantTypModus: nil)
    ...
    lektionen[13-1].quizSetting?.stimmhaftigkeit          = .init(controlTyp: .StimmhaftigkeitTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[14-1].quizSetting?.stimmhaftigkeit          = .init(controlTyp: .StimmhaftigkeitTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[15-1].quizSetting?.stimmhaftigkeit          = .init(controlTyp: .StimmhaftigkeitTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[16-1].quizSetting?.stimmhaftigkeit          = .init(controlTyp: .StimmhaftigkeitTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[17-1].quizSetting?.stimmhaftigkeit          = .init(controlTyp: .StimmhaftigkeitTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[18-1].quizSetting?.stimmhaftigkeit          = .init(controlTyp: .StimmhaftigkeitTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[19-1].quizSetting?.stimmhaftigkeit          = .init(controlTyp: .StimmhaftigkeitTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[20-1].quizSetting?.stimmhaftigkeit          = .init(controlTyp: .StimmhaftigkeitTyp, modus: .Abfrage, konsonantTypModus: nil)
    ...
    lektionen[17-1].quizSetting?.vokalOderHalbvokal       = .init(controlTyp: .VokalOderHalbvokalTyp, modus: .Abfrage, konsonantTypModus: nil) //nur anzeige?
    lektionen[18-1].quizSetting?.vokalOderHalbvokal       = .init(controlTyp: .VokalOderHalbvokalTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[19-1].quizSetting?.vokalOderHalbvokal       = .init(controlTyp: .VokalOderHalbvokalTyp, modus: .Abfrage, konsonantTypModus: nil)
    lektionen[20-1].quizSetting?.vokalOderHalbvokal       = .init(controlTyp: .VokalOderHalbvokalTyp, modus: .Abfrage, konsonantTypModus: nil)
    ...
    lektionen[16-1].quizSetting?.konsonantTyp                 = .init(controlTyp: .KonsonantTyp, modus: .Abfrage, konsonantTypModus: .Nasal)
    lektionen[17-1].quizSetting?.konsonantTyp                 = .init(controlTyp: .KonsonantTyp, modus: .Abfrage, konsonantTypModus: .Nasal)
    lektionen[18-1].quizSetting?.konsonantTyp                 = .init(controlTyp: .KonsonantTyp, modus: .Abfrage, konsonantTypModus: .Sibilant)
    lektionen[19-1].quizSetting?.konsonantTyp                 = .init(controlTyp: .KonsonantTyp, modus: .Abfrage, konsonantTypModus: .Hauchlaut)
    lektionen[20-1].quizSetting?.konsonantTyp                 = .init(controlTyp: .KonsonantTyp, modus: .Abfrage, konsonantTypModus: .Hauchlaut)
